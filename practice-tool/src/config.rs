...
impl TryFrom<String> for FlagSpec {
    ...
    fn try_from(value: String) -> Result<Self, Self::Error> {
        match value.as_str() {
            ...
            "hurtbox" => Ok(FlagSpec::new("伤害区域显示", |c| &c.rend_hurtbox)),
            ...
            "collision" => Ok(FlagSpec::new("无碰撞", |c| &c.collision)),
